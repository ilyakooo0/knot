...
fn check_src(src: &str) -> Vec<Diagnostic> {
    ...
    let (diags, _monad, _type_info, _local, _targets, _refined, _json, _elem,  _show_units, _sum_floats, _rel_fields, _with_fields, _ty_args, _implicit_refs, _implicit_dict_args) =
