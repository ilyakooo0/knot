...
Not yet implemented: traits, impls, views, derived relations, routes, migrations, temporal queries, pattern matching in do-bind (constructor patterns filter but don't branch), partial application.
